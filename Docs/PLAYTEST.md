...
This delta: A still crouch into a tag eases the guard into the connect. A still crouch into a punch is unchanged. A crouch walk into a tag is unchanged. An air crouch into a tag is unchanged. A slide into a tag is unchanged. A crouch claim is unchanged. A punch into a tag is unchanged. Connect time is unchanged.
