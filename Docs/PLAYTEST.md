...
This delta: A slide into a ski eases the wedge into the glide. The glide then holds. A ski into a slide is unchanged. A walk into a ski is unchanged. Ski speed is unchanged.
