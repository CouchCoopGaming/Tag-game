...
This delta: A jump out of a claim eases the claim into the air pose. The air pose then holds. The slow push stays off that path. Claim time is unchanged. Jump height is unchanged.
