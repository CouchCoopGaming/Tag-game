...
This delta: A jump out of a tag eases the connect into the air pose. The air pose then holds. The slow push stays off that path. Flinch time is unchanged. Jump height is unchanged.
