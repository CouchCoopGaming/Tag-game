...
This delta: A ski into a crouch walk eases the glide into the low stride. The stride then holds. A ski into a still crouch is unchanged. A crouch walk into a still crouch is unchanged. Ski speed is unchanged.
