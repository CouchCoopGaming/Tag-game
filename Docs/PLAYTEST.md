...
This delta: A tag into an air dash eases the connect into the burst. The burst still holds. A punch miss into an air dash is unchanged. A tag into a jump is unchanged. A crouch tag is unchanged. Duration and cooldown are unchanged.
