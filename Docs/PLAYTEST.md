...
| **Playground** | West play places link along **BARS W** (x=11); the merry apron runs under that lane at z 22-26 (the z=24 joint stays mulch). Beam lane x=13.5 stops 0.25 m short of the Loop W tower. East bars at x=62.5 sit on the open kickball edge. The play-place net sits beside the tubes; the low beam lands on the open SW corner of the deck (that pad tile is gone). Slide pits stay three tiles long with a second outer column. Crash torso is on the west side of the bowl's north lip so the middle of the cross looks north onto open lawn. Ninja blade stays a north-rim rail. After pull: **CutArenaBootstrap** Rebuild / **PgkLandmarkPlacer -> Place**. |
...
5. Slide pit is still three tiles long (~2.2 m after the chute, ~0.4 m before the spine). Mid and far have a second outer column. A third column on the forts would sit on the west bars. Rings still grow only the column away from the west spine. A second loop wing would clip the vault rail. Say if the runout still feels short.
6. Army crawl is shifted to local (-2, -4.5): about 1 m south of the stair, west edge short of Spawn_SE. Knight's copy should miss Spawn_NE. Bunker ladder is on the net side of the deck (local 1.20, 0.45). Play-place net is local (-4.15, -0.78), about 0.25 m off the tube street. The beam is local (-2.52, -1.19): about 0.06 m off the net, 0.13 m south of the deck, 0.08 m south of the corner post. The SW pad tile is omitted so the beam can land there. Top is 0.41, same band as the 0.40 stoop. It should read as a step onto the corner, not a wall.
...
8. **Corners.** Helmet stays (2.5, 51.2) scale 0.30. That footprint is the largest yaw-0 fit west of Spawn_NW; the mesh is still ~4.1 graybox tall, so the read is vertical. Foxhole (69.55, 2.55) scale 0.35. Tron disc (42.1, 11.5) off Conn_Tron. Crash torso is (29.79, 32.20) scale 0.28 yaw 0, grounded (stem -0.322), on the west side of the north lip (x about 28.5–31.1). The middle of the cross, from about x=31 to the east lane, should look north onto open lawn. Ninja blade stays (36, 48.70) yaw 90 scale 0.725, height ~1.0, about 0.76 m north of the curb. Shortening it drops the height below a rail; the 10:1 mesh cannot be both. Say if the west-side torso still walls your line through Crash, or the rail still reads as a curb.
