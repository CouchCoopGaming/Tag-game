...
This delta: Letting go of a ski into a crouch walk eases the glide into the low stride. A still crouch still ends in the guard. A walk out of a ski is unchanged. Speed is unchanged. Jet stays off.
