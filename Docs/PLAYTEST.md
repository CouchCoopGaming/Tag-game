...
This delta: Becoming It into a tag eases the claim into the connect. Becoming It into a punch is unchanged. Becoming It into an air dash is unchanged. Becoming It into a jump is unchanged. An air crouch into a tag is unchanged. A crouch claim is unchanged. Connect time is unchanged. Claim time is unchanged.
