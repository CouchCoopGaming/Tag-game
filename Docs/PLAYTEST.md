...
This delta: A wall run into a still crouch eases into the guard. A climb into a still crouch is unchanged. A wall run into a walk is unchanged. The leave time is unchanged.
