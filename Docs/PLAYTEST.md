...
This delta: After an air dash, the pose eases into the fall or the run. That pose then holds. The slow slew stays off that path. Duration and cooldown are unchanged.
