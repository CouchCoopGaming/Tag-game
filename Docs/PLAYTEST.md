...
This delta: A crouch walk into a walk eases the low stride into the walk. The walk then holds. A crouch walk into a run is unchanged. A still crouch into a walk is unchanged. The drop time is unchanged.
