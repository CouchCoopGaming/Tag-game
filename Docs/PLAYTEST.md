...
This delta: A walk into a ski eases the walk into the glide. The glide then holds. A walk into a slide is unchanged. A run into a ski is unchanged. A crouch walk into a ski is unchanged. Ski speed is unchanged.
