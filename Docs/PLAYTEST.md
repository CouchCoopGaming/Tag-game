...
This delta: A sprint into the air eases the stride arms into the air pose. The air pose then holds. The slow reach stays off that path. A walk into a jump is unchanged. Jump height is unchanged.
