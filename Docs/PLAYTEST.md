...
This delta: An air dash into a punch eases the burst into the cock. The windup then holds. The strike is unchanged. A slide into a punch is unchanged. A ski into a tag is unchanged. A slide into a tag is unchanged. Windup time is unchanged. Duration and cooldown are unchanged.
