...
This delta: A still crouch into a crouch walk eases the planted guard into the low stride. The stride then holds. A walk into a crouch walk is unchanged. A run into a crouch walk is unchanged. A crouch walk into a still crouch is unchanged.
