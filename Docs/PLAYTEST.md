...
| **Playground** | West play places link along **BARS W** (x=11); the merry apron runs under that lane at z 22-26 (the z=24 joint stays mulch). Beam lane x=13.5 stops 0.25 m short of the Loop W tower. East bars at x=62.5 sit on the open kickball edge. The play-place climb net sits beside the tube street, with a low beam from that net to the deck. Slide pits stay three tiles long with a second outer column (a third column hits the west bars). Crash torso is a narrower marker on the bowl's north lip, about 1.2 m off the lane and the north spine. Ninja blade is a north-rim rail, stepped off the curb. After pull: **CutArenaBootstrap** Rebuild / **PgkLandmarkPlacer -> Place**. |
...
8. **Corners.** Helmet stays (2.5, 51.2) scale 0.30. That footprint is the largest yaw-0 fit west of Spawn_NW; the mesh is still ~4.1 graybox tall, so the read is vertical. Foxhole (69.55, 2.55) scale 0.35. Tron disc (42.1, 11.5) off Conn_Tron. Crash torso is (36, 32.20) scale 0.28 yaw 0, grounded (stem -0.322). It sits between the crash conns with about 1.2 m of air to the cross lane and to the north spine. Ninja blade is a rail at (36, 48.70) yaw 90 scale 0.725, height ~1.0, about 0.76 m north of the curb. The mesh is ten times longer than it is tall, so this is the rail-height seat; it cannot also be a short bar. Say if the torso still walls the chase or the rail still reads as a curb.
