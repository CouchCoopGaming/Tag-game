...
This delta: A climb into a ski eases the grab into the glide. A soft landing into a slide is unchanged. A wall run into a ski is unchanged. A climb into a jump is unchanged. A climb into a punch is unchanged. A jump into a ski is unchanged. Ski speed is unchanged. Exit time is unchanged.
