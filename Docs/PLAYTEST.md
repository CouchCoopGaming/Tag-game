...
This delta: An air dash into a tag eases the burst into the connect. The connect then holds. An air dash into a punch is unchanged. A climb into a punch is unchanged. A jump into a tag is unchanged. Connect time is unchanged. Duration and cooldown are unchanged.
