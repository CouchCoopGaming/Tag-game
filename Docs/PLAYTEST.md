...
This delta: A whiff into a still crouch eases the miss into the guard. The guard then holds. A tag into a still crouch is unchanged. A punch into a still crouch is unchanged. Whiff time is unchanged.
