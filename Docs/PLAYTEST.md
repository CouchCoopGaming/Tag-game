...
This delta: A walk into a tag eases the walk into the connect. The connect then holds. A walk into a punch is unchanged. A jump into a tag is unchanged. A still crouch into a tag is unchanged. Connect time is unchanged.
