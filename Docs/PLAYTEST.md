...
This delta: A ski into a slide eases the glide into the wedge. A still crouch into a slide is unchanged. A crouch walk into a ski is unchanged. A crouch walk into a slide is unchanged. A slide into a ski is unchanged. slideBoost stays 0. Ski speed is unchanged.
