...
This delta: A slide into a crouch walk eases the wedge into the low stride. A still crouch still ends in the guard. A slide into a walk is unchanged. Speed is unchanged.
