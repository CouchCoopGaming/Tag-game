...
This delta: A wall jump eases the wall pose into the air pose. The air pose then holds. The slow push stays off that path. Exit time is unchanged. Jump height is unchanged.
