...
This delta: A punch that misses in a still crouch eases into the guard. A standing miss still eases into the idle hang. A walk miss and a sprint miss are unchanged. Windup time is unchanged.
