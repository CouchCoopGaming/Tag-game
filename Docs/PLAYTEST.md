...
This delta: A ski into a run eases the glide into the run. The run then holds. A ski into a walk is unchanged. A run into a ski is unchanged. Ski speed is unchanged.
