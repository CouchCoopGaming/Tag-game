...
This delta: A punch into a slide eases the cock or the strike into the wedge. A punch into a ski is unchanged. A slide into a punch is unchanged. A crouch into a slide is unchanged. A ski into a slide is unchanged. A jump into a slide is unchanged. slideBoost stays 0. Windup time is unchanged.
