...
This delta: A tag into a punch eases the connect into the windup. A punch into a tag is unchanged. A dash coming off cooldown into a punch is unchanged. A crouch tag is unchanged. A tag into a jump is unchanged. Windup time is unchanged. Connect time is unchanged.
