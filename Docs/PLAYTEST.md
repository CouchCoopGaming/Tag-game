...
This delta: A crouch walk into a ski eases the low stride into the glide. The glide then holds. A still crouch into a ski is unchanged. A walk into a ski is unchanged. Ski speed is unchanged.
