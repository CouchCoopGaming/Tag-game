...
| **Playground** | Figure-8 + outer ring chase (soft-play, slides, monkey bars, wall strips, slide banks, merry/swing/kickball/hopscotch). **SoftPlay tubes grounded**; stem seat Y offsets on slides/stairs/tunnels. After pull: **CutArenaBootstrap** Rebuild / **PgkLandmarkPlacer → Place**. Colliders on spawn (boxes if FBX not readable) |
