...
| **Playground** | West play places link along **BARS W** (x=11); the merry apron runs under that lane at z 22-26 (the z=24 joint stays mulch). Beam lane x=13.5 stops 0.25 m short of the Loop W tower. East bars at x=62.5 sit on the open kickball edge. The play-place net sits beside the tubes; the low beam is already on the SW deck corner (closer hits the post). Slide pits stay three tiles long with a second outer column. Crash torso is on the NW lawn, off the bowl, so the cross and both lips stay open. Ninja blade stays a north-rim rail. After pull: **CutArenaBootstrap** Rebuild / **PgkLandmarkPlacer -> Place**. |
...
6. Army crawl is shifted to local (-2, -4.5): about 1 m south of the stair, west edge short of Spawn_SE. Knight's copy should miss Spawn_NE. Bunker ladder is on the net side of the deck (local 1.20, 0.45). Play-place net is local (-4.15, -0.78), about 0.25 m off the tube street. The beam stays local (-2.52, -1.19). That is the step: 0.06 m off the net, 0.02 m off the deck edge in x, 0.13 m south of the deck face, 0.08 m south of the post. Moving it north hits the post. The SW pad tile stays omitted. Top is 0.41, same band as the 0.40 stoop.
...
8. **Corners.** Helmet stays (2.5, 51.2) scale 0.30. That footprint is the largest yaw-0 fit west of Spawn_NW; the mesh is still ~4.1 graybox tall. Foxhole (69.55, 2.55) scale 0.35. Tron disc (42.1, 11.5) off Conn_Tron. Crash torso moved to (12, 52.12) scale 0.28 yaw 0, grounded (stem -0.322). It is 1.0 m north of Spawn_NW (x about 10.7–13.3, z about 51.1–53.1), off the bowl. The west lip was still in the west junction of the cross; the gap between the outer lanes and the spines is too narrow for this mesh. Ninja blade stays (36, 48.70) yaw 90 scale 0.725, height ~1.0. Shortening it drops below rail height. Say if the NW torso crowds the spawn exit, or the rail still reads as a curb.
