...
`PGK_Slide_TubeDeck_2m` is placed once on soft-play, once on astro, and once on army. Yaw 90, stem 0, pivot local (0, 0, 5.90). The FBX rise is mesh Z (0.028..2.482); the placer pitches the mesh -90 X so root-local Y is that rise. Mouth center 1.91 m, shell top 2.48 m, low mouth on the mulch (stem 0, before the Tube90 +0.52 rule). West sleeve: 3.28 m off the tube street, about 7 m off the ground `Toy_Slide`, 7.2 m off the dome. Army sleeve: 1.49 m off the spiral. Knight keeps the straight chute. Props are parked. `Mega_SlideTube` and `PGK_Slide_Tube90` stay unspawned and unscaled. Deck pivots in use are 0.40 / 0.80 / 1.60 / 2.00. A `PGK_Deck_2x2` is 0.08 thick above its pivot, so the tallest walk surface is 2.08. The tallest rise from mulch onto a deck pivot is 2.00. No yaw seats Tube90 or Mega on that grid without a float or a bury. No new deck was added.
...
`PGK_Slide_TubeDeck_2m` is that mesh, pitched -90 X in the placer so the crown is on Y. One each on soft-play, astro, and army. Do not place or scale `Mega_SlideTube` or `PGK_Slide_Tube90`. Props are parked.
...
Graybox pad cubes are gone (they were stretching HiPoly into a low-poly look). Flow stones are gone. The chase is kit districts. A clearance pass found no solid on the four spines or the crash cross, and no chase pinched under 0.5 m. Spawn_SE's bumper is local (-2.136, 0.565), 0.57 m south of the army crawl, so that east mouth stays open. SoftS, the NE hop, and the merry-spine bar were not densified.

- **Soft-play** (14, 9.75) and **astro loft** (14, 44.25): decks 0.80 / 1.60 / 2.00, spiral at local (2.50, 0, -0.5) yaw 180, one `PGK_Slide_TubeDeck_2m` each, yaw 90 stem 0 at local z=5.90 (the ground slide stays on the south lawn). Tube street at z=-4 with the north mouth at z=-3. Rung ladder at local (-1.15, 0, 0.90) yaw 90 (~0.12 m off the deck; closer hits the post). Climb net at local (-4.15, 0, -0.78) yaw 90, about 0.25 m off the tube street. Low beam at local (-2.52, 0, -1.19) yaw 0 steps off that net onto the SW corner (that pad tile is omitted): 0.13 m south of the deck, 0.08 m south of the post. Slide pit is still three tiles long (~2.2 m after the chute). Mid and far tiles have an outer wing plus a second outer column. A third column meets the west bars. The inner wing would sit on the Conn ramp. A `Toy_Slide` at local (5.90, 0, -5.53) is west-only: stem -0.095 seats the low mouth, high end stays ~2.41, 0.66 m east of the tube cap and 0.79 m south of the street. East forts do not get it. East of that mouth, `Play_Wall_SoftRing` is three `Toy_WallPanel`s at z=1.70, x 21.40-26.20 (0.86 m off the slide, 1.35 m west of the south ring ground stair, 0.79 m south of the ring side stair). Soft-play world z about 1.0-4.2. Astro yaw 180 puts the same piece north of its tubes, 0.36 m east of Spawn_NW.
- **Army bunker** (58, 9.75) and **knight keep** (58, 44.25): same tower and pit. Army's chute is `PGK_Slide_TubeDeck_2m` (yaw 90, stem 0, mesh pitched -90 X, pivot local z=5.90), 1.49 m off the spiral. Knight keeps the straight chute. Crawl at local (-2, -4.5), climb net, a 1.8 m `Toy_Ladder` at local (1.20, 0, 0.45) yaw -90 on the net side (reaches the 1.60 deck), and the same 2.4 m rung as soft-play at local (-1.15, 0, 0.90) yaw 90 (reaches the 2.00 deck). Side stair ends at local z=0.45; the rung starts at z=0.62. A `Toy_SpiralClimber` at local (2.80, 0, 0) is east-only: feet y=0, top 2.40, about 0.90 m off the deck face. Army world x 59.9-61.8, z 8.8-10.7 (0.40 m south of the south bar). Knight yaw 180 world x 54.2-56.1, z 43.3-45.2 (1.7 m north of Conn_Knight). West forts do not get this climber. A `Toy_SpringRider` at local (2.80, 0, -2.302) is the step between that climb and the crawl, 0.56 m off the crawl's north face and the south safety tiles. A second `Toy_SpringRider` at local (2.80, 0, 1.748) is the step from the conn up to that climb, 0.56 m off the spiral and 0.66 m off the conn. Army world (60.80, 11.50), x 60.45-61.30, z 11.26-11.74. Knight yaw 180 world (55.20, 42.50), x 54.70-55.55, z 42.26-42.74. The crawl-side spring is Army world (60.80, 7.45), x 60.45-61.30, z 7.21-7.69. Knight yaw 180 world (55.20, 46.55), x 54.70-55.55, z 46.31-46.79. West forts do not get it. One `Toy_Crate` at local (-0.80, 0, -6.81) is the bunker apron: 0.56 m off the crawl wall, 2.4 m off both mouths. Army world (57.20, 2.94), 1.72 m west of Spawn_SE's bumper. Knight yaw 180 world (58.80, 51.06), 1.68 m west of the shield. West forts do not get the crate. `Play_Bars_RingArmy` is two `PGK_Monkey_4m` at z=3.35, x 42.3-50.7, abutting the south ring's east monkey and 1.3 m west of the army crawl mouth. `Play_Step_ArmyApron` is one `Toy_MushroomSteps` at (53.73, 2.85), x 52.48-55.07, z 2.41-3.29, 0.56 m south of the army crawl wall and 1.78 m west of the crate. Knight does not get it. `Play_Step_ArmyMouth` is one `Toy_MushroomSteps` at (50.10, 5.00), x 48.85-51.44, z 4.56-5.44, 0.56 m west of the army crawl mouth and 0.78 m south of the south rail. Knight does not get it. `Play_Bars_RingKnight` is three `PGK_Monkey_4m` at z=51, x 42.3-54.9, abutting the north ring's east monkey and 1.1 m west of the knight crawl mouth. `Play_Step_KnightMouth` is one `Toy_MushroomSteps` at (54.10, 49.48), x 52.85-55.44, z 49.04-49.92, 0.56 m west of the knight crawl mouth and 1.04 m off the climb net and those bars. Army does not get it. `Play_Step_KnightEast` is one `Toy_MushroomSteps` at (65.81, 48.75), x 64.56-67.15, z 48.31-49.19, 0.56 m east of the knight crawl's east mouth. Army does not get it.
- **BARS W** x=11 and **BARS E** x=62.5. West stays at 11 (mast). `Play_Bars_SoftMerry` is one `PGK_Monkey_4m` at (11, 17.78) yaw 90 across the south spine. Posts at z 15.74-15.82 and 19.74-19.82 are outside the spine (z 16.4-19.6). Rungs at y=2 leave the chase open. Merry apron covers the middle spans. East bar mesh is fully on the kickball rubber (pad starts x=62).
...
- **West climber dome** local (?4.66, ?6.70) on soft-play and astro only. `Toy_ClimberDome` stem ?0.330, top ~1.31. Soft-play world x 7.95?10.73, z 1.66?4.44 (0.59 m south of the tubes, 0.43 m west of the apron mushrooms). Astro yaw 180: x 17.27?20.05, z 49.56?52.34, 0.45 m west of the west lane. East bunkers do not get it. East of the astro dome, `Play_Wall_AstroRing` is two `Toy_WallPanel`s at z=51, x 21.36-24.56 (1.31 m off the dome, 1.32 m west of the north ring side stair).
- **Soft-play south apron** (14.5, 2.6): balance beam along X, mushroom steps at local (-2.9, 0.6) yaw 90, an east-west mushroom at local (-0.10, 1.30) between the beam and the tube mesh (x 13.15-15.74, z 3.46-4.34, 0.68 m off both), spring rider at local (2.7, 0.7), two hop tiles at local (-0.6, -1.35)/(0.6, -1.35). Tube mesh ends z=5.03; mushrooms end z=4.45. Spring ends x=17.70, 1.56 m west of the ground slide (x=19.26). Not copied onto astro. Not a bench. `Play_Beam_SoftSlide` is one `PGK_Balance_Beam_3m` at (18.48, 2.97) yaw 90 in that gap: x 18.42-18.54, z 1.47-4.47, 0.72 m off the spring and the slide, 0.56 m south of the tube mesh. Outside the 1.11 m aisles. Astro does not get it.
