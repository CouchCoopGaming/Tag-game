...
- **Landmarks:** helmet (2.5, 51.2) scale 0.30 (max yaw-0 fit; ~4.1 graybox tall); foxhole (69.55, 2.55) scale 0.35 yaw 0; shield (66, 52.2); tron disc (42.1, 11.5) off Conn_Tron; crash torso (29.79, 32.20) scale 0.28 yaw 0, stem −0.322, west side of the north lip so the middle of the cross stays open; ninja rail (36, 48.70) yaw 90 scale 0.725, stem −0.334, height ~1.0, ~0.76 m north of the curb (10:1 mesh cannot be a short rail).
