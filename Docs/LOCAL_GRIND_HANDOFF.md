...
- **Soft-play south apron** (14.5, 2.6): balance beam along X, mushroom steps at local (-2.9, 0.6) yaw 90, spring rider at local (2.7, 0.7). Tube mesh ends z=5.03; mushrooms end z=4.45. Spring ends x=17.70, 1.56 m west of the ground slide (x=19.26). Not copied onto astro. Not a bench.
...
- **NE pocket** (66.2, 45.0): net frame yaw 90, mushroom steps at local (0.3, -1.85), spring rider at local (-1.45, 0). Two hop tiles at local (1.55, -0.95) and (1.55, 0.55); east edge x=68.25 flush with the spawn seesaw. Lawn north of the NE bench (ends z=42.13) and east of the bars (face x=62.54), south of the knight crawl (z=47.35) and west of the spawn toys (seesaw starts x=68.26). Spring x starts 64.40. Not a bench. Spawn_NE's southwest exit stays north of it.
