...
- **NE pocket** (66.2, 45.0): net frame yaw 90, mushroom steps at local (0.3, -1.85), spring rider at local (-1.45, 0). Lawn north of the NE bench (ends z=42.13) and east of the bars (face x=62.54), south of the knight crawl (z=47.35) and west of the spawn toys (seesaw starts x=68.26). Spring x starts 64.40. Not a bench. Spawn_NE's southwest exit stays north of it.
