...
namespace Tag.Art
{
    ...
    public class PgkLandmarkPlacer : MonoBehaviour
    {
        ...
        /// a spring between that climb and the crawl, a spring between the conn and the climb,
        /// and one supply crate on the outer apron.
        ...
        static void AddBunkerAnnex(List<(string id, Vector3 p, float y)> pieces)
        {
            ...
            // Spring on the conn side of the spiral. Spiral face is local z=0.946.
            // Center z=1.748 leaves 0.56 m. Conn edge is local z=2.65, 0.66 m past the spring.
            // Local x=2.80 lines up with the spiral and stays 0.95 m off the safety tiles.
            // Army world (60.80, 11.50): x 60.45-61.30, z 11.26-11.74, 1.16 m west of the east bars.
            // Knight yaw 180 world (55.20, 42.50): x 54.70-55.55, z 42.26-42.74.
            // West play places do not get this.
            pieces.Add(("Toy_SpringRider", new Vector3(2.80f, 0f, 1.748f), 0f));
        ...
        /// <summary>
        /// Three more 4.2 m monkeys continuing the north ring's east bar toward the knight crawl.
        /// North ring centers are 31.8 / 36.0 / 40.2 at z=51, so the next seats are 44.4, 48.6, 52.8.
        /// West edge x=42.3 abuts the ring monkey. East edge x=54.9 is 1.1 m west of the
        /// knight crawl mouth (x=56, z 47.35-50.15). The bars sit north of that mouth.
        /// </summary>
        int RingKnightBars(Transform root)
        {
            var parent = MakeGroup(root, "Play_Bars_RingKnight", new Vector3(48.6f, 0f, 51f), 0f);
            return SpawnList(parent, new List<(string id, Vector3 p, float y)>
            {
        ...
        /// Beam, mushrooms, a step under the tube wall, spring, and two hop tiles. Not a bench.
        ...
        int SoftPlaySouthCluster(Transform root)
        {
            ...
            return SpawnList(parent, new List<(string id, Vector3 p, float y)>
            {
                ...
                // Yaw 0: length along X, under the tube wall. x 13.15-15.74, z 3.46-4.34.
                // 0.68 m north of the beam and 0.68 m south of the tube mesh.
                // 1.11 m east of the north-south mushrooms and 1.11 m west of the spring.
                ("Toy_MushroomSteps", new Vector3(-0.10f, 0f, 1.30f), 0f),
