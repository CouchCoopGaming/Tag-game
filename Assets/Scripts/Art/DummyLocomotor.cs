...
namespace Tag.Art
{
    ...
    public class DummyLocomotor : MonoBehaviour
    {
        ...
        bool _jumpFromClimb;
        bool _jumpClimbSnap;
        float _jumpClimbSnapIn;
        Quaternion _climbJumpUaL, _climbJumpUaR, _climbJumpLaL, _climbJumpLaR;
        Quaternion _climbJumpUlL, _climbJumpUlR, _climbJumpLlL, _climbJumpLlR;
        Quaternion _climbJumpSp, _climbJumpHp, _climbJumpHd;
        bool _jumpFromWall;
        bool _jumpWallSnap;
        ...
        bool _jumpHardLandSnap;
        float _jumpHardLandSnapIn;
        Quaternion _hardJumpUaL, _hardJumpUaR, _hardJumpLaL, _hardJumpLaR;
        ...
        bool _dashSlideSnap;
        Quaternion _dashSlideUaL, _dashSlideUaR, _dashSlideLaL, _dashSlideLaR;
        Quaternion _dashSlideUlL, _dashSlideUlR, _dashSlideLlL, _dashSlideLlR;
        Quaternion _dashSlideSp, _dashSlideHp, _dashSlideHd;
        ...
        bool _slideFromCrouchWalk;
        float _slideFromCrouchWalkIn;
        Quaternion _crouchWalkSlideUaL, _crouchWalkSlideUaR, _crouchWalkSlideLaL, _crouchWalkSlideLaR;
        Quaternion _crouchWalkSlideUlL, _crouchWalkSlideUlR, _crouchWalkSlideLlL, _crouchWalkSlideLlR;
        Quaternion _crouchWalkSlideSp, _crouchWalkSlideHp, _crouchWalkSlideHd;
        bool _climbFromDash;
        ...
        bool _stopFromSprint;
        float _stopFromSprintIn;
        ...
        bool _stopFromIdle;
        float _stopFromIdleIn;
        Quaternion _idleStopUaL, _idleStopUaR, _idleStopLaL, _idleStopLaR;
        Quaternion _idleStopUlL, _idleStopUlR, _idleStopLlL, _idleStopLlR;
        Quaternion _idleStopSp, _idleStopHp, _idleStopHd;
        bool _walkFromIdle;
        ...
        float _skiFromJumpIn;
        bool _jumpSkiSnap;
        Quaternion _jumpSkiUaL, _jumpSkiUaR, _jumpSkiLaL, _jumpSkiLaR;
        Quaternion _jumpSkiUlL, _jumpSkiUlR, _jumpSkiLlL, _jumpSkiLlR;
        Quaternion _jumpSkiSp, _jumpSkiHp, _jumpSkiHd;
        ...
        void LateUpdate()
        {
            ...
            bool fromSkiSlide = sliding && !_dropSlide && !jumpIntoSlide && !fromSoftSlide && !fromWallSlide && !fromClimbSlide && !fromGrappleSlide && !fromClaimSlide && !fromReadySlide && !fromPunchSlide && !fromTagSlide && !fromMissSlide && !fromCrouchSlide
                ...
                && _upperArmL != null && _spine != null && _hips != null && _upperLegL != null && _head != null;
            bool fromCrouchWalkSlide = sliding && !_dropSlide && !jumpIntoSlide && !fromSoftSlide && !fromWallSlide && !fromClimbSlide && !fromGrappleSlide && !fromClaimSlide && !fromReadySlide && !fromPunchSlide && !fromTagSlide && !fromMissSlide && !fromCrouchSlide && !fromSkiSlide
                && !_airDashPoseWas && !jet && _crouchFromWalk && _dropVis > 0.2f
                && _upperArmL != null && _spine != null && _hips != null && _upperLegL != null && _head != null;
            if (jumpIntoSlide)
            {
            ...
            else if (!fromPunchSlide && !fromTagSlide && !fromMissSlide && !fromCrouchSlide && !fromCrouchWalkSlide && !fromSkiSlide && !fromSoftSlide && !fromWallSlide && !fromClimbSlide && !fromGrappleSlide && !fromClaimSlide && !fromReadySlide)
            {
                if (sliding && !_dropSlide && _crouchFromStand && _dropVis > 0.2f && !_slideFromCrouch)
                    _crouchToSlide = 1f;
                if (sliding && !_dropSlide && _crouchFromWalk && _dropVis > 0.2f && !_slideFromCrouchWalk)
                    _crouchWalkToSlide = 1f;
                if (sliding && !_dropSlide && _skiBlend > 0.2f && !_slideFromSki)
            ...
            if (fromCrouchSlide && !_slideFromCrouch)
            {
                ...
                // A still crouch into a ski has its own ease. A crouch walk into a slide has its own ease.
                // The slow guard blend stays off this path. slideBoost stays 0.
            ...
            if (fromCrouchWalkSlide && !_slideFromCrouchWalk)
            {
                // The low stride eases into the wedge. A still crouch into a slide has its own ease.
                // A walk into a slide keeps its ease. The slow stride blend stays off this path.
                // slideBoost stays 0.
                _slideFromCrouchWalk = true;
                _slideFromCrouchWalkIn = 0f;
                _crouchWalkToSlide = 0f;
                _crouchWalkSlideUaL = _upperArmL.localRotation;
                _crouchWalkSlideUaR = _upperArmR.localRotation;
                _crouchWalkSlideLaL = _lowerArmL.localRotation;
                _crouchWalkSlideLaR = _lowerArmR.localRotation;
                _crouchWalkSlideUlL = _upperLegL.localRotation;
                _crouchWalkSlideUlR = _upperLegR.localRotation;
                _crouchWalkSlideLlL = _lowerLegL.localRotation;
                _crouchWalkSlideLlR = _lowerLegR.localRotation;
                _crouchWalkSlideSp = _spine.localRotation;
                _crouchWalkSlideHp = _hips.localRotation;
                _crouchWalkSlideHd = _head.localRotation;
            }
            bool fromSprintSlide = sliding && !_dropSlide && !jumpIntoSlide && !fromSoftSlide && !fromWallSlide && !fromClimbSlide && !fromGrappleSlide && !fromClaimSlide && !fromReadySlide && !fromPunchSlide && !fromTagSlide && !fromMissSlide && !fromCrouchSlide && !fromCrouchWalkSlide && !fromSkiSlide
            ...
            bool fromWalkSlide = sliding && !_dropSlide && !fromSprintSlide && !jumpIntoSlide && !fromSoftSlide && !fromWallSlide && !fromClimbSlide && !fromGrappleSlide && !fromClaimSlide && !fromReadySlide && !fromPunchSlide && !fromTagSlide && !fromMissSlide && !fromCrouchSlide && !fromCrouchWalkSlide && !fromSkiSlide
            ...
            if (fromWalkSlide && !_slideFromWalk)
            {
                ...
                // A crouch walk into a slide has its own ease. A still crouch into a slide keeps its ease.
            ...
            if (fromSkiSlide && !_slideFromSki)
            {
                ...
                // A crouch walk into a ski has its own ease. A crouch walk into a slide has its own ease.
                // A slide into a ski has its own ease. The slow glide blend stays off this path.
            ...
            if (skiing && _skiBlend <= 0.02f)
            {
                ...
                if (fromJump && !_skiFromJump && _upperArmL != null && _spine != null && _hips != null && _upperLegL != null && _head != null)
                {
                    // The hang or the absorb eases into the glide. A hard landing into a ski keeps its ease.
                    // A walk into a ski keeps its ease. Ski speed is unchanged. Jump height is unchanged.
                    _skiFromJumpIn = 0f;
                    _jumpSkiSnap = true;
                    _jumpSkiUaL = _upperArmL.localRotation;
                    _jumpSkiUaR = _upperArmR.localRotation;
                    _jumpSkiLaL = _lowerArmL.localRotation;
                    _jumpSkiLaR = _lowerArmR.localRotation;
                    _jumpSkiUlL = _upperLegL.localRotation;
                    _jumpSkiUlR = _upperLegR.localRotation;
                    _jumpSkiLlL = _lowerLegL.localRotation;
                    _jumpSkiLlR = _lowerLegR.localRotation;
                    _jumpSkiSp = _spine.localRotation;
                    _jumpSkiHp = _hips.localRotation;
                    _jumpSkiHd = _head.localRotation;
                }
                else if (fromJump && !_skiFromJump)
                    _skiFromJumpIn = 1f;
                ...
                if (fromPunch && !_skiFromPunch)
                {
                    ...
                    // A slide into a ski has its own ease. A jump into a ski has its own ease.
                ...
                if (fromSoft && !_skiFromSoft)
                {
                    ...
                    // A jump into a ski has its own ease. A punch into a ski keeps its ease.
                ...
                if (fromHard && !_skiFromHard)
                {
                    ...
                    // A jump into a ski has its own ease. An air dash into a ski keeps its ease.
                ...
                if (fromDart && !_skiFromDart)
                {
                    ...
                    // An air dash into a ski keeps its ease. A jump into a ski has its own ease.
                ...
                if (fromWall && !_skiFromWall)
                {
                    ...
                    // A jump into a ski has its own ease. Ski speed is unchanged. Exit time is unchanged.
                    _skiFromWall = true;
                    _skiFromWallIn = 0f;
            ...
            if (_jumpSkiSnap && skiing)
                _skiFromJumpIn = Mathf.MoveTowards(_skiFromJumpIn, 1f, dt / 0.04f);
            ...
            if (!grounded && _wasGrounded && _motor != null && _motor.Velocity.y > 1.5f)
            {
                ...
                {
                    // The stride arms ease into the air pose, then the air pose holds.
                    // A walk into a jump keeps its ease. Jump height is unchanged.
                    _airFromStride = true;
                    _airFromStrideIn = 0f;
                    _strideAirUaL = _upperArmL.localRotation;
            ...
            if (_jumpFromClimb && !_jumpClimbSnap && !punching
                && _upperArmL != null && _lowerArmL != null && _upperArmR != null && _lowerArmR != null
                && _spine != null && _hips != null && _head != null
                && _upperLegL != null && _lowerLegL != null && _upperLegR != null && _lowerLegR != null)
            {
                ...
                _jumpClimbSnap = true;
                _jumpClimbSnapIn = 0f;
                _climbJumpUaL = _upperArmL.localRotation;
                _climbJumpUaR = _upperArmR.localRotation;
                _climbJumpLaL = _lowerArmL.localRotation;
                _climbJumpLaR = _lowerArmR.localRotation;
                _climbJumpUlL = _upperLegL.localRotation;
                _climbJumpUlR = _upperLegR.localRotation;
                _climbJumpLlL = _lowerLegL.localRotation;
                _climbJumpLlR = _lowerLegR.localRotation;
                _climbJumpSp = _spine.localRotation;
                _climbJumpHp = _hips.localRotation;
            ...
            if (_jumpFromHardLand && !_jumpHardLandSnap && !punching
                && _upperArmL != null && _lowerArmL != null && _upperArmR != null && _lowerArmR != null
                && _spine != null && _hips != null && _head != null
                && _upperLegL != null && _lowerLegL != null && _upperLegR != null && _lowerLegR != null)
            {
                // The deep absorb eases into the air pose, then the air pose holds.
                // The slow push stays off this path. Land time is unchanged when you stay down.
                // Jump height is unchanged.
                _jumpHardLandSnap = true;
                _jumpHardLandSnapIn = 0f;
                _hardJumpUaL = _upperArmL.localRotation;
                _hardJumpUaR = _upperArmR.localRotation;
                _hardJumpLaL = _lowerArmL.localRotation;
                _hardJumpLaR = _lowerArmR.localRotation;
                _hardJumpUlL = _upperLegL.localRotation;
                _hardJumpUlR = _upperLegR.localRotation;
                _hardJumpLlL = _lowerLegL.localRotation;
                _hardJumpLlR = _lowerLegR.localRotation;
                _hardJumpSp = _spine.localRotation;
                _hardJumpHp = _hips.localRotation;
            ...
            if (_jumpHardLandSnap && _jumpFromHardLand && !punching)
            {
                if (_jumpHardLandSnapIn < 0.98f)
                    _jumpHardLandSnapIn = Mathf.MoveTowards(_jumpHardLandSnapIn, 1f, dt / 0.04f);
            }
                ...
                && _upperArmL != null && _spine != null && _hips != null && _upperLegL != null && _head != null)
            {
                ...
                // An air dash into a slide has its own ease. A ski and a slide into a dash keep their ease.
                ...
                && _upperArmL != null && _spine != null && _hips != null && _upperLegL != null && _head != null)
            {
                ...
                // A climb into a ski keeps its ease. An air dash into a slide has its own ease.
            ...
            if (!dashingAir && _airDashPoseWas && sliding && !jet && !skiing)
            {
                ...
                // slideBoost stays 0. Duration and cooldown are unchanged.
                if (!_slideFromDash && _upperArmL != null && _spine != null && _hips != null && _upperLegL != null && _head != null)
                {
                    _dashSlideSnap = true;
                    _dashSlideUaL = _upperArmL.localRotation;
                    _dashSlideUaR = _upperArmR.localRotation;
                    _dashSlideLaL = _lowerArmL.localRotation;
                    _dashSlideLaR = _lowerArmR.localRotation;
                    _dashSlideUlL = _upperLegL.localRotation;
                    _dashSlideUlR = _upperLegR.localRotation;
                    _dashSlideLlL = _lowerLegL.localRotation;
                    _dashSlideLlR = _lowerLegR.localRotation;
                    _dashSlideSp = _spine.localRotation;
                    _dashSlideHp = _hips.localRotation;
                    _dashSlideHd = _head.localRotation;
                }
                _slideFromDash = true;
                _slideFromDashIn = 0f;
            }
            ...
            {
                _slideFromDashIn = Mathf.MoveTowards(_slideFromDashIn, 1f, dt / 0.04f);
                if (_slideFromDashIn >= 0.98f && !dashTell)
                {
                    _slideFromDash = false;
                    _dashSlideSnap = false;
                }
            }
            else
            {
            ...
            else if (!jet)
            {
                ...
                if (!sliding && !crouch)
                {
                    if (!_stopFromSprint && grounded && speed <= 0.35f && !air && !dashing && !_airDashArms
                        && _prevRunAmt > 0.4f && (_stopGait > 0.35f || _runVis > 0.35f)
                        && _upperArmL != null && _spine != null && _hips != null && _upperLegL != null && _head != null)
                    {
                        _stopFromSprint = true;
                        _stopFromSprintIn = 0f;
                        _sprintStopUaL = _upperArmL.localRotation;
                        _sprintStopUaR = _upperArmR.localRotation;
                        _sprintStopLaL = _lowerArmL.localRotation;
                        _sprintStopLaR = _lowerArmR.localRotation;
                        _sprintStopUlL = _upperLegL.localRotation;
                        _sprintStopUlR = _upperLegR.localRotation;
                        _sprintStopLlL = _lowerLegL.localRotation;
                        _sprintStopLlR = _lowerLegR.localRotation;
                        _sprintStopSp = _spine.localRotation;
                    ...
                    {
                        bool idleStop = grounded && speed <= 0.35f && !air && !dashing && !_airDashArms
                            && (_stopGait > 0.02f || _runVis > 0.02f || Mathf.Abs(_cycle - plant) > 0.05f);
                        if (idleStop && !_stopFromIdle
                            && _upperArmL != null && _lowerArmL != null && _upperArmR != null && _lowerArmR != null
                            && _spine != null && _hips != null && _head != null
                            && _upperLegL != null && _lowerLegL != null && _upperLegR != null && _lowerLegR != null)
                        {
                            // The pose eases into the idle, then the idle holds.
                            // A sprint into a stop keeps its ease. A walk into a stop keeps its ease.
                            // Speed is unchanged.
                            _stopFromIdle = true;
                            _stopFromIdleIn = 0f;
                            _idleStopUaL = _upperArmL.localRotation;
                            _idleStopUaR = _upperArmR.localRotation;
                            _idleStopLaL = _lowerArmL.localRotation;
                            _idleStopLaR = _lowerArmR.localRotation;
                            _idleStopUlL = _upperLegL.localRotation;
                            _idleStopUlR = _upperLegR.localRotation;
                            _idleStopLlL = _lowerLegL.localRotation;
                            _idleStopLlR = _lowerLegR.localRotation;
                            _idleStopSp = _spine.localRotation;
                            _idleStopHp = _hips.localRotation;
                            _idleStopHd = _head.localRotation;
                        }
                        if (_stopFromIdle)
                        {
                            _cycle = plant;
            ...
            if (_stopFromWalk && grounded && speed <= 0.35f && !air && !dashing && !_airDashArms && !crouch && !sliding && !jet)
            {
                ...
                _stopFromWalk = false;
            // Stay on the idle after the cut so the slow close cannot resume.
            // A sprint into a stop keeps its ease. A walk into a stop keeps its ease. Speed is unchanged.
            ...
            if (lunging || dashing)
            {
                ...
                bool groundWhip = !(airDashing || (_airDashArms && !lunging));
                if (groundWhip && !_groundWhipSnap
                    && _upperArmL != null && _lowerArmL != null && _upperArmR != null && _lowerArmR != null
                    && _spine != null && _hips != null && _head != null
                    && _upperLegL != null && _lowerLegL != null && _upperLegR != null && _lowerLegR != null)
                {
                    // The whip eases into the hang, then the hang holds.
                    // An air dash keeps its own recover. Dash time is unchanged.
                    _groundWhipSnap = true;
                    _groundWhipIn = 0f;
                    _groundWhipUaL = _upperArmL.localRotation;
                    _groundWhipUaR = _upperArmR.localRotation;
                    _groundWhipLaL = _lowerArmL.localRotation;
                    _groundWhipLaR = _lowerArmR.localRotation;
                    _groundWhipUlL = _upperLegL.localRotation;
                    _groundWhipUlR = _upperLegR.localRotation;
                    _groundWhipLlL = _lowerLegL.localRotation;
                    _groundWhipLlR = _lowerLegR.localRotation;
                    _groundWhipSp = _spine.localRotation;
                    _groundWhipHp = _hips.localRotation;
                    _groundWhipHd = _head.localRotation;
                }
                if (_groundWhipSnap && groundWhip)
                {
                    if (_groundWhipIn < 0.98f)
                        _groundWhipIn = Mathf.MoveTowards(_groundWhipIn, 1f, dt / 0.04f);
                }
                else if (!groundWhip)
                    _groundWhipSnap = false;
                ...
                else
                {
                    ...
                    // The whip eases into that hang, then the hang holds. An air dash keeps its own recover.
                    float groundPose = _groundWhipSnap ? 0f : dashStretchPose;
                    _uaLT = Quaternion.Slerp(
                        _uaL0 * Quaternion.Euler(-16f, 0f, armZ),
                    ...
                    _laRT = Quaternion.Slerp(
                        ...
                        groundPose);
                    _spineT = Quaternion.Slerp(_spine0 * Quaternion.Euler(14f, 0f, 0f), _spineT, Mathf.Lerp(0.4f, 1f, groundPose));
                    _hipsT = Quaternion.Slerp(_hips0 * Quaternion.Euler(8f, 0f, 0f), _hipsT, Mathf.Lerp(0.4f, 1f, groundPose));
                    if (_groundWhipSnap && _groundWhipIn < 0.98f)
                    {
                        float intoGround = _groundWhipIn;
                        _uaLT = Quaternion.Slerp(_groundWhipUaL, _uaLT, intoGround);
                        _uaRT = Quaternion.Slerp(_groundWhipUaR, _uaRT, intoGround);
                        _laLT = Quaternion.Slerp(_groundWhipLaL, _laLT, intoGround);
                        _laRT = Quaternion.Slerp(_groundWhipLaR, _laRT, intoGround);
                        _spineT = Quaternion.Slerp(_groundWhipSp, _spineT, intoGround);
                        _hipsT = Quaternion.Slerp(_groundWhipHp, _hipsT, intoGround);
                        _headT = Quaternion.Slerp(_groundWhipHd, _headT, intoGround);
                    }
                }
            }
            else if (jet)
            ...
            else if (air)
            {
                ...
                if (_airFromStride && _airFromStrideIn < 0.98f && !_airDashArms && !_jumpFromWalk
                    && !_jumpFromStill && !_jumpFromCrouchWalk && !_jumpFromSki && !_jumpFromSlide
                    && !_jumpFromDash && !_jumpFromWall && !_jumpFromClimb && !_jumpFromPunch)
                {
                    // The stride arms ease into the air pose, then the air pose holds.
                    // A walk into a jump has its own ease. The slow reach stays off this path.
                    // Jump height is unchanged.
                    float intoAir = _airFromStrideIn;
                    _uaLT = Quaternion.Slerp(_strideAirUaL, _uaLT, intoAir);
            ...
            if (lunging || dashing)
            {
                ...
                {
                    float intoGround = _groundWhipIn;
                    _ulLT = Quaternion.Slerp(_groundWhipUlL, _ulLT, intoGround);
                    _ulRT = Quaternion.Slerp(_groundWhipUlR, _ulRT, intoGround);
            ...
            if (_skiFromJump && !_jumpSkiSnap && skiing && _skiBlend < 0.98f && !punching)
            {
                ...
                // A jump into a ski has its own ease. Ski speed is unchanged.
                float intoGlide = _skiBlend;
                float glideL = RunArmPitch(-sinC, 16f);
                float glideR = RunArmPitch(sinC, 16f);
                float glideFrontL = Mathf.Max(0f, sinC);
            ...
            else if (_wallExit > 0f)
            {
                ...
                if (!_skiFromClimb && !_skiFromWall && !_jumpWallSnap && !_jumpClimbSnap)
                {
                float w = _wallExit;
                ...
                && !_jumpDashSnap && !_jumpWallSnap)
            {
                ...
                _laRT = Quaternion.Slerp(_climbJumpLaR, _laRT, intoClimbAir);
                _spineT = Quaternion.Slerp(_climbJumpSp, _spineT, intoClimbAir);
                _hipsT = Quaternion.Slerp(_climbJumpHp, _hipsT, intoClimbAir);
                _headT = Quaternion.Slerp(_climbJumpHd, _headT, intoClimbAir);
                _ulLT = Quaternion.Slerp(_climbJumpUlL, _ulLT, intoClimbAir);
                _ulRT = Quaternion.Slerp(_climbJumpUlR, _ulRT, intoClimbAir);
                _llLT = Quaternion.Slerp(_climbJumpLlL, _llLT, intoClimbAir);
            ...
            if (_jumpFromHardLand && _pushOff > 0.02f && !punching && !wallRun && !climb && !_jumpHardLandSnap)
            {
            ...
            if (_jumpHardLandSnap && _jumpHardLandSnapIn < 0.98f && _jumpFromHardLand && !punching
                && !_airFromIdle && !_airFromStride && !_jumpFromWalk && !_jumpFromStill
                && !_jumpDashSnap && !_jumpWallSnap && !_jumpClimbSnap && !_jumpAirCrouchSnap
                && !_jumpSoftLandSnap)
            {
                ...
                // The slow push stays off this path. Land time is unchanged when you stay down.
                // Jump height is unchanged.
                float intoHardAir = _jumpHardLandSnapIn;
                _uaLT = Quaternion.Slerp(_hardJumpUaL, _uaLT, intoHardAir);
                _uaRT = Quaternion.Slerp(_hardJumpUaR, _uaRT, intoHardAir);
                _laLT = Quaternion.Slerp(_hardJumpLaL, _laLT, intoHardAir);
                _laRT = Quaternion.Slerp(_hardJumpLaR, _laRT, intoHardAir);
                _spineT = Quaternion.Slerp(_hardJumpSp, _spineT, intoHardAir);
                _hipsT = Quaternion.Slerp(_hardJumpHp, _hipsT, intoHardAir);
                _headT = Quaternion.Slerp(_hardJumpHd, _headT, intoHardAir);
                _ulLT = Quaternion.Slerp(_hardJumpUlL, _ulLT, intoHardAir);
                _ulRT = Quaternion.Slerp(_hardJumpUlR, _ulRT, intoHardAir);
            ...
            if (_stopFromSprint && _stopFromSprintIn < 0.98f && !stepping && grounded && speed <= 0.35f
                ...
                && !_idleFromSki && !_walkFromSprint && !_sprintFromWalk)
            {
                ...
                _laRT = Quaternion.Slerp(_sprintStopLaR, _laRT, intoStop);
                _spineT = Quaternion.Slerp(_sprintStopSp, _spineT, intoStop);
                _hipsT = Quaternion.Slerp(_sprintStopHp, _hipsT, intoStop);
                _headT = Quaternion.Slerp(_sprintStopHd, _headT, intoStop);
                _ulLT = Quaternion.Slerp(_sprintStopUlL, _ulLT, intoStop);
            ...
            if (_stopFromIdle && _stopFromIdleIn < 0.98f && !stepping && grounded && speed <= 0.35f
                && !crouch && !sliding && !jet && !punching && !wallRun && !climb && !air && !dashing
                && !_stopFromSprint && !_stopFromWalk && !_idleFromSki && !_walkFromSprint && !_sprintFromWalk)
            {
                // The pose eases into the idle, then the idle holds.
                ...
                _laRT = Quaternion.Slerp(_idleStopLaR, _laRT, intoIdleStop);
                _spineT = Quaternion.Slerp(_idleStopSp, _spineT, intoIdleStop);
                _hipsT = Quaternion.Slerp(_idleStopHp, _hipsT, intoIdleStop);
                _headT = Quaternion.Slerp(_idleStopHd, _headT, intoIdleStop);
                _ulLT = Quaternion.Slerp(_idleStopUlL, _ulLT, intoIdleStop);
                _ulRT = Quaternion.Slerp(_idleStopUlR, _ulRT, intoIdleStop);
                _llLT = Quaternion.Slerp(_idleStopLlL, _llLT, intoIdleStop);
                _llRT = Quaternion.Slerp(_idleStopLlR, _llRT, intoIdleStop);
            }
            ...
            if (_slideFromSki && !_slideFromCrouch && !_slideFromMiss && !_slideFromReady && !_slideFromClaim && !_slideFromGrapple && !_slideFromWall && !_slideFromClimb && !_slideFromSoft && !_slideFromTag && !_slideFromPunch && !_slideFromDash && sliding && !jet && !skiing && !wallRun && !climb && !punching)
            {
                ...
                // A crouch walk into a slide has its own ease. A slide into a ski has its own ease.
                ...
                if (intoWedge < 0.98f)
                {
                    ...
                    _spineT = Quaternion.Slerp(_skiSlideSp, wedgeSp, intoWedge);
                    _hipsT = Quaternion.Slerp(_skiSlideHp, wedgeHp, intoWedge);
                    _headT = Quaternion.Slerp(_skiSlideHd, wedgeHd, intoWedge);
                    _ulLT = Quaternion.Slerp(_skiSlideUlL, wedgeThighL, intoWedge);
                    _ulRT = Quaternion.Slerp(_skiSlideUlR, wedgeThighR, intoWedge);
                    _llLT = Quaternion.Slerp(_skiSlideLlL, wedgeKneeL, intoWedge);
                    _llRT = Quaternion.Slerp(_skiSlideLlR, wedgeKneeR, intoWedge);
                }
                else
                {
                    _uaLT = wedgeL;
            ...
            if (_slideFromDash && !_skiFromDash && !airDashing && !punching && !wallRun && !climb && _slideFromDashIn < 0.98f)
            {
                ...
                if (_dashSlideSnap)
                {
                    _uaLT = Quaternion.Slerp(_dashSlideUaL, wedgeL, intoWedge);
            ...
            {
                // The hang or the absorb eases into the glide, then the glide holds.
                // A hard landing into a ski keeps its ease. A walk into a ski keeps its ease.
                // Ski speed is unchanged. Jump height is unchanged.
                float intoGlide = _skiFromJumpIn;
                float glideL = Mathf.Max(0f, sinC);
                float glideR = Mathf.Max(0f, -sinC);
                float skateL = RunArmPitch(-sinC, 16f);
                float skateR = RunArmPitch(sinC, 16f);
                ...
                if (intoGlide < 0.98f)
                {
                    _uaLT = Quaternion.Slerp(_jumpSkiUaL, skiL, intoGlide);
                    _uaRT = Quaternion.Slerp(_jumpSkiUaR, skiR, intoGlide);
                    _laLT = Quaternion.Slerp(_jumpSkiLaL, skiElL, intoGlide);
                    _laRT = Quaternion.Slerp(_jumpSkiLaR, skiElR, intoGlide);
                    _spineT = Quaternion.Slerp(_jumpSkiSp, skiSp, intoGlide);
                    _hipsT = Quaternion.Slerp(_jumpSkiHp, skiHp, intoGlide);
                    _headT = Quaternion.Slerp(_jumpSkiHd, skiHd, intoGlide);
                    _ulLT = Quaternion.Slerp(_jumpSkiUlL, skiThighL, intoGlide);
                    _ulRT = Quaternion.Slerp(_jumpSkiUlR, skiThighR, intoGlide);
                    _llLT = Quaternion.Slerp(_jumpSkiLlL, skiKneeL, intoGlide);
                    _llRT = Quaternion.Slerp(_jumpSkiLlR, skiKneeR, intoGlide);
                }
                else
                {
                    _uaLT = skiL;
            ...
            if (_skiFromWall && !_skiFromClimb && !_skiFromSoft && !_skiFromTag && !_skiFromPunch && !_skiFromDash && !_skiFromJump && skiing && !jet && !crouch && !wallRun && !climb && _skiFromWallIn < 0.98f)
            {
                ...
                // A soft landing into a ski keeps its ease. A jump into a ski has its own ease.
                // Ski speed is unchanged. Exit time is unchanged.
            ...
            if (_skiFromClimb && !_skiFromWall && !_skiFromSoft && !_skiFromTag && !_skiFromPunch && !_skiFromDash && !_skiFromJump && skiing && !jet && !crouch && !wallRun && !climb && _skiFromClimbIn < 0.98f)
            {
                ...
                // A climb into a punch keeps its ease. A jump into a ski has its own ease.
                // Ski speed is unchanged. Exit time is unchanged.
            ...
            if (_skiFromDart && !_skiFromGrapple && !_skiFromHard && !_skiFromSoft && !_skiFromTag && !_skiFromPunch && !_skiFromDash && !_skiFromJump && skiing && !jet && !crouch && !wallRun && !climb && _skiFromDartIn < 0.98f)
            {
                ...
                // A jump into a ski has its own ease. An air crouch into a slide keeps its ease.
            ...
            if (_skiFromSoft && !_skiFromHard && !_skiFromTag && !_skiFromPunch && !_skiFromDash && !_skiFromJump && skiing && !jet && !crouch && !wallRun && !climb && _skiFromSoftIn < 0.98f)
            {
                ...
                // A hard landing into a ski keeps its own ease. A jump into a ski has its own ease.
            ...
            if (_skiFromPunch && !_skiFromDash && skiing && !jet && !crouch && !wallRun && !climb && _skiFromPunchIn < 0.98f)
            {
                ...
                // A jump into a ski has its own ease. Ski speed is unchanged. Windup time is unchanged.
            ...
            if (_skiFromDash && !airDashing && !punching && !wallRun && !climb && skiing && !jet && !crouch && _skiFromDashIn < 0.98f)
            {
                ...
                // An air dash into a slide has its own ease. A ski into a dash keeps its ease.
