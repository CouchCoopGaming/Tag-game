...
namespace TagArena.Movement
{
    ...
    public class SpeedEnergyHUD : MonoBehaviour
    {
        ...
        const float TrailNearMissWarnM = 6.2f; // earlier soft edge so TRAIL! reads before contact (AI peels ~9.2 m)
        ...
        const float AllStandingsShowSec = 4.2f; // slightly longer Least It board read
